...
//USE_MP3_Polled, USE_MP3_Timer1 or USE_MP3_SimpleTimer
...
#else // otherwise use pinout of typical adafruit MP3 Player Shield.
 ...
 */
#define USE_MP3_REFILL_MEANS USE_MP3_Polled //USE_MP3_INTx
